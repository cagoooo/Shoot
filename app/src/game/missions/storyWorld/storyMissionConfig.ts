...
export const storyMissions: readonly StoryMissionConfig[] = [
  ...
  },
  {
    ...
    steps: [
      { title: '安全洗手', description: '選出洗手時需要的兩個步驟。', requiredChoices: 2, choices: [{ id: 'soap', title: '使用肥皂', description: '幫助帶走髒污。' }, { id: 'rub', title: '仔細搓洗', description: '連指縫也要洗到。' }, { id: 'rush', title: '碰一下就走', description: '洗得不夠完整。' }] },
      { title: '照顧水站', description: '選出兩個讓飲水更安心的做法。', requiredChoices: 2, choices: [{ id: 'clean', title: '保持出水口清潔', description: '減少髒污停留。' }, { id: 'bottle', title: '使用乾淨水壺', description: '保護自己也保護水站。' }, { id: 'sharecup', title: '共用同一個杯子', description: '不衛生。' }] },
      { title: '健康提醒', description: '選兩個能照顧同學的行動。', requiredChoices: 2, choices: [{ id: 'rest', title: '不舒服時休息', description: '讓身體有恢復時間。' }, { id: 'tell', title: '告訴可信任的大人', description: '需要時可以得到協助。' }, { id: 'hide', title: '一直忍耐不說', description: '可能錯過需要的幫忙。' }] },
    ],
  ...
  },
  {
    ...
    steps: [
      { title: '觀察天氣', description: '選兩個暴雨前值得先注意的資料。', requiredChoices: 2, choices: [{ id: 'rain', title: '雨量預報', description: '知道可能下多少雨。' }, { id: 'warning', title: '警報訊息', description: '了解是否需要準備。' }, { id: 'rumor', title: '未確認傳言', description: '不應當作防災依據。' }] },
      { title: '建立通道', description: '選兩種讓路線更安全的工程做法。', requiredChoices: 2, choices: [{ id: 'drain', title: '清理排水口', description: '減少積水。' }, { id: 'sign', title: '設置明顯標示', description: '讓大家知道安全方向。' }, { id: 'block', title: '堵住出口', description: '會讓撤離更危險。' }] },
      { title: '準備避難包', description: '選兩種真正能幫助撤離的物品。', requiredChoices: 2, choices: [{ id: 'water', title: '飲用水', description: '維持基本需要。' }, { id: 'light', title: '手電筒', description: '停電時能照明。' }, { id: 'toy', title: '大型玩具箱', description: '會增加負擔。' }] },
    ],
  ...
  },
  {
    ...
    steps: [
      { title: '認識潮汐', description: '選兩個靠近潮池時的安全做法。', requiredChoices: 2, choices: [{ id: 'schedule', title: '查看潮汐時間', description: '知道海水何時變化。' }, { id: 'path', title: '走在指定步道', description: '保護自己和潮池生物。' }, { id: 'rush', title: '追著海浪跑', description: '容易發生危險。' }] },
      { title: '回收海廢', description: '選兩種需要優先帶走的漂流物。', requiredChoices: 2, choices: [{ id: 'bottle', title: '塑膠瓶', description: '可能碎成微小塑膠。' }, { id: 'net', title: '廢棄漁網', description: '可能纏住生物。' }, { id: 'shell', title: '活的貝殼', description: '是潮池生物的家。' }] },
      { title: '守護海洋', description: '選兩個能讓海洋更乾淨的生活行動。', requiredChoices: 2, choices: [{ id: 'reusable', title: '使用可重複用品', description: '減少一次性塑膠。' }, { id: 'sort', title: '做好回收分類', description: '讓資源被再利用。' }, { id: 'litter', title: '把垃圾留在沙灘', description: '會回到海洋裡。' }] },
    ],
  ...
  },
  {
    ...
    steps: [
      { title: '聽見每個人的資料', description: '選兩個合作時需要做到的行動。', requiredChoices: 2, choices: [{ id: 'listen', title: '輪流聆聽', description: '每個人的發現都很重要。' }, { id: 'evidence', title: '拿出觀察證據', description: '用資料一起做決定。' }, { id: 'interrupt', title: '一直打斷別人', description: '會讓合作變困難。' }] },
      { title: '公平分工', description: '選兩種讓每個人都能參與的方法。', requiredChoices: 2, choices: [{ id: 'roles', title: '分配不同角色', description: '每個人都有能發揮的任務。' }, { id: 'help', title: '互相幫忙', description: '遇到困難一起想辦法。' }, { id: 'exclude', title: '排除不一樣的人', description: '不公平也失去好點子。' }] },
      { title: '啟動星核', description: '選兩個能持續守護地球的合作行動。', requiredChoices: 2, choices: [{ id: 'share', title: '分享好方法', description: '讓更多人一起做。' }, { id: 'review', title: '一起檢查改良', description: '看見成果也找出下一步。' }, { id: 'blame', title: '互相責怪', description: '不能解決問題。' }] },
    ],
