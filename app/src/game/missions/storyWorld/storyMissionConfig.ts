...
export const storyMissions: readonly StoryMissionConfig[] = [
  ...
  },
  {
    ...
    guide: { name: '工程師阿磚', icon: '👷' },
    steps: [
      { title: '觀察天氣', description: '走到社區中心，選兩個暴雨前值得先注意的資料。', requiredChoices: 2, position: { x: 0, z: 7 }, dialogue: '好工程從看資料開始。動工之前，先確認我們知道的事是真的。', choices: [{ id: 'rain', title: '雨量預報', description: '知道可能下多少雨。' }, { id: 'warning', title: '警報訊息', description: '了解是否需要準備。' }, { id: 'rumor', title: '未確認傳言', description: '不應當作防災依據。' }] },
